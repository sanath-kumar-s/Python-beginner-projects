<h1 align="center">
    <img src="assets/icon.png" width="28"> Tick Tack Toe
</h1>

<p align="center">
    <i>Enjoy the tick tack toe game</i>
</p>
...
<p align="center">
  <img src = "assets/picture.png" alt = "ScreenCapture" width = "500" >
</p><!--OPTIONAL BUT RECOMMENDED-->

## 📖 About

This project is a fully functional Tic-Tac-Toe game built using Python and Pygame.
It is designed as a beginner-friendly project while still introducing concepts like game loops, event handling, UI rendering, and persistent data storage.

## The game includes a graphical interface, turn-based gameplay, and a scoring system that saves progress using a JSON file.

## ✨ Features

- Interactive GUI using Pygame
- Turn-based gameplay (Player X vs Player O)
- Persistent score tracking using JSON
- Automatic win and draw detection
- Smooth game reset after each round
