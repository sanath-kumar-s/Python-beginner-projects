<h1 align="center">
    <img src="icon.png" width="28"> File Downloader
</h1>

<p align="center">
    <i>Download any media file from web</i>
</p>
...
A lightweight command-line tool that downloads files from any valid URL and saves them locally. It works with images, videos, documents, or any downloadable media, and provides real-time feedback using a progress bar.
